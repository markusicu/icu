 ...
 *
 * <p>To create a FractionPrecision, use one of the factory methods on Precision.
 *
 * @stable ICU 60
 * @see NumberFormatter
 */
public abstract class FractionPrecision extends Precision {
    ...
    FractionPrecision(FractionPrecision other, MathContext newMode, Precision.OverrideTZD newTZD) {
     ...
     *
     * @param minSignificantDigits Pad trailing zeros to achieve this minimum number of significant
     *     digits.
     * @param maxSignificantDigits Round the number to achieve this maximum number of significant
     *     digits.
     * @param priority How to disambiguate between fraction digits and significant digits.
     ...
     * as "3", not "3.0".
     *
     * <p>This is equivalent to {@code withSignificantDigits(1, minSignificantDigits, RELAXED)}.
     *
     * @param minSignificantDigits The number of significant figures to guarantee.
     ...
     *
     * <p>This is equivalent to {@code withSignificantDigits(1, maxSignificantDigits, STRICT)}.
     *
     * @param maxSignificantDigits Round the number to no more than this number of significant
     *     figures.
     * @return A Precision for chaining or passing to the NumberFormatter rounding() setter.
     * @throws IllegalArgumentException if the input number is too big or smaller than 1.
     * @stable ICU 60
