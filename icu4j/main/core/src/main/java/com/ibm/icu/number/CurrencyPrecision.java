 ...
 *
 * <p>To create a CurrencyPrecision, use one of the factory methods on Precision.
 *
 * @stable ICU 60
 * @see NumberFormatter
 */
public abstract class CurrencyPrecision extends Precision {
     ...
     * specified in unit() or via a CurrencyAmount passed into format(Measure) is automatically
     * applied to currency rounding strategies. However, this method enables you to override that
